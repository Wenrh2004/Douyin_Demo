...
var file_publish_proto_rawDesc = []byte{
	...
	0x0a, 0x66, 0x65, 0x65, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5c, 0x0a, 0x1a, 0x44,
	...
	0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x22, 0x71, 0x0a, 0x1b, 0x44, 0x6f, 0x75,
	...
	0x0b, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x5f, 0x6d, 0x73, 0x67, 0x22, 0x43, 0x0a, 0x12,
	...
	0x6e, 0x22, 0x9c, 0x01, 0x0a, 0x13, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x4c, 0x69, 0x73,
	...
	0x28, 0x0b, 0x32, 0x12, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2e, 0x66, 0x65, 0x65, 0x64,
	...
	0x32, 0xdc, 0x01, 0x0a, 0x0e, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x70, 0x0a, 0x13, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x50, 0x75, 0x62,
	0x6c, 0x69, 0x73, 0x68, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2a, 0x2e, 0x64, 0x6f, 0x75,
	0x79, 0x69, 0x6e, 0x2e, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x2e, 0x44, 0x6f, 0x75, 0x79,
	...
	,
...
var file_publish_proto_goTypes = []interface{}{
	(*DouyinPublishActionRequest)(nil),  // 0: douyin.publish.DouyinPublishActionRequest
	(*DouyinPublishActionResponse)(nil), // 1: douyin.publish.DouyinPublishActionResponse
	(*PublishListRequest)(nil),          // 2: douyin.publish.PublishListRequest
	(*PublishListResponse)(nil),         // 3: douyin.publish.PublishListResponse
	(*feed.Video)(nil),                  // 4: douyin.feed.Video
}
var file_publish_proto_depIdxs = []int32{
	4, // 0: douyin.publish.PublishListResponse.video_list:type_name -> douyin.feed.Video
	0, // 1: douyin.publish.PublishService.DouyinPublishAction:input_type -> douyin.publish.DouyinPublishActionRequest
	2, // 2: douyin.publish.PublishService.PublishList:input_type -> douyin.publish.PublishListRequest
	1, // 3: douyin.publish.PublishService.DouyinPublishAction:output_type -> douyin.publish.DouyinPublishActionResponse
	3, // 4: douyin.publish.PublishService.PublishList:output_type -> douyin.publish.PublishListResponse
