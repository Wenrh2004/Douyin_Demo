...
func (u userDo) GetByRoles(rolesName []string) (result []*model.User, err error) {
	...
	generateSQL.WriteString("query data by roles and return it as *slice of pointer* (The below blank line is required to comment for the generated method) // SELECT * FROM users WHERE role IN ? ")
